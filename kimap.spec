...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kimap-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kimap-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kimap-23.08.2
cd %{_builddir}/kimap-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697255531
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5IMAP.so.5.24.2
/usr/lib64/libKPim5IMAP.so.5
/usr/lib64/libKPim5IMAP.so.5.24.2
