...
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/kimap-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/kimap-22.04.3.tar.xz.sig
...
%prep
%setup -q -n kimap-22.04.3
cd %{_builddir}/kimap-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657571753
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kimap-22.04.3/.krazy.license %{buildroot}/usr/share/package-licenses/kimap/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/kimap-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kimap/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/kimap-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kimap/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kimap-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kimap/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kimap-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kimap/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kimap-22.04.3/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kimap/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kimap-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kimap/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kimap-22.04.3/README.md.license %{buildroot}/usr/share/package-licenses/kimap/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/kimap-22.04.3/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/kimap/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
%find_lang libkimap5
...
/usr/include/KF5/KIMAP/kimap_version.h
...
/usr/lib64/libKF5IMAP.so.5.20.3
