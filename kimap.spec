...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/kimap-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/kimap-22.12.0.tar.xz.sig
...
%prep
%setup -q -n kimap-22.12.0
cd %{_builddir}/kimap-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670535198
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IMAP.so.5.22.0
