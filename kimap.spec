...
Version  : 24.12.3
Release  : 92
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kimap-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kimap-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kimap-24.12.3.tar.xz.sig
...
%setup -q -n kimap-24.12.3
cd %{_builddir}/kimap-24.12.3
pushd ..
cp -a kimap-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742470866
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6IMAP.so.6.3.3
/usr/lib64/libKPim6IMAP.so.6
/usr/lib64/libKPim6IMAP.so.6.3.3
